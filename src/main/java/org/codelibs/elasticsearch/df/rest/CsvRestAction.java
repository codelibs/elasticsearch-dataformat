...
public class CsvRestAction extends BaseRestHandler {

    @Inject
    public CsvRestAction(final Settings settings, final Client client,
            final RestController restController) {
        super(settings, client);

        restController.registerHandler(RestRequest.Method.GET,
                "/{index}/{type}/_csv", this);
        restController.registerHandler(RestRequest.Method.GET, "/{index}/_csv",
                this);
    }
    ...
    public void handleRequest(final RestRequest request,
        ...
        try {
            ...
            builder.field(
                    "description",
                    "This is a elasticsearch-response response: "
                            + new Date().toString());
            builder.endObject();
